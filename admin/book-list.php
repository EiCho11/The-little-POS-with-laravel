<?php
  ...
  $total = mysql_query("SELECT id FROM books");
  ...
  $result = mysql_query("SELECT books.*, categories.name FROM books LEFT JOIN categories ON books.category_id = categories.id ORDER BY books.created_date DESC LIMIT $start, $limit");
?>
